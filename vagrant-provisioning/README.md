...
### Clone the repo
```
$ git clone https://github.com/watchingant/k8s-lab-utils
$ cd k8s-lab-utils/vagrant-provisioning
```
...
```
$ cd k8s-lab-utils/vagrant-provisioning/misc/nfs-subdir-external-provisioner
...
```
$ cd k8s-lab-utils/vagrant-provisioning/misc/metallb
